...
<head>
  ...
  <title>Drawing Art Supplies System : Orders Details</title>
  <!-- Bootstrap -->
...
<img src="shoplogo.png" alt="Shop Logo" style="position: absolute; top: 100px; left: 40px; max-height: 400px; max-width: 600px;">
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        ...
        tbl_customers_a188417_pt2 WHERE
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
      <div class="panel panel-default">
        <div class="panel-heading" style="font-weight:bold; background-color: #e098fa;"><strong>Order Details</strong></div>
